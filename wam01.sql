...
(
	...
	-- 도로 유형
	ROAD_TY VARCHAR(5),
	CONSTRAINT t_am_wtl_pip_pk PRIMARY KEY (ASST_SN)
) WITHOUT OIDS;
...
(
	...
	-- 노후도 점수
	TMWR_SCOR NUMERIC,
	CONSTRAINT t_inev_cnd_pk PRIMARY KEY (CND_SN)
) WITHOUT OIDS;
...
(
	...
	CONSTRAINT t_inev_grad_pk PRIMARY KEY (MTRPIPE_CD, GRAD_SN)
) WITHOUT OIDS;
...
(
	...
	-- 보정 계수
	REVISN_COEF NUMERIC,
	CONSTRAINT t_inev_lyyy_revisn_pk PRIMARY KEY (LYNG_YYNU_SN)
) WITHOUT OIDS;
...
(
	...
	-- 평가 종류
	EVL_KND VARCHAR(5),
	CONSTRAINT t_inev_m_pk PRIMARY KEY (EVL_SN)
) WITHOUT OIDS;
...
(
	...
	-- 가중치 값
	WGHT_VAL NUMERIC,
	CONSTRAINT t_inev_wght_pk PRIMARY KEY (EVL_ITM_CD, MTRPIPE_CD)
) WITHOUT OIDS;
...
(
	...
	-- 밸브 수
	VALE_CO NUMERIC,
	CONSTRAINT t_inev_wtl_pip_pk PRIMARY KEY (ASST_SN)
) WITHOUT OIDS;
