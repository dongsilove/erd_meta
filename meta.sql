...
(
	...
	CONSTRAINT PK_AU_DEPT PRIMARY KEY (DEPT_CD)
) WITHOUT OIDS;
...
(
	...
	-- 부서 코드
	DEPT_CD varchar(5) NOT NULL,
	CONSTRAINT PK_AU_USER PRIMARY KEY (USER_ID)
) WITHOUT OIDS;
...
(
	...
	CONSTRAINT PK_CM_CODE_GRP PRIMARY KEY (GRP_CD)
) WITHOUT OIDS;
...
(
	...
	CONSTRAINT PK_CM_CODE PRIMARY KEY (GRP_CD, CD)
) WITHOUT OIDS;
