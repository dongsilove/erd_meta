...
COMMENT ON COLUMN T_AU_USER.PWD_SALT IS 'PWD_SALT';
...
COMMENT ON COLUMN T_CM_PRJCT.PRJCT_BGNG_YMD IS '프로젝트 시작 일자';
COMMENT ON COLUMN T_CM_PRJCT.PRJCT_END_YMD IS '프로젝트 종료 일자';
